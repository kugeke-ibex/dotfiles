...
--
-- キーマップ:
--   <leader>na  nb add (現在の notebook に新規ノート)
--   <leader>nA  nb add (notebook を選んで新規ノート)
--   <leader>ni  nb 画像インポート (img-clip 連携あり)
--   <leader>nl  nb リンク挿入
--   <leader>nm  ノートを別の notebook に移動
--   <leader>nM  現在のバッファ (nb 外) を notebook に取り込む
--   <leader>np  nb notes picker
--   <leader>ng  nb notes grep
--   <leader>nP  Claude Code plans picker
--   <leader>nL  最新の plan を開く
